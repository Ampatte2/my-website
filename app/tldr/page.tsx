      ...
      <div key={index} className="timeline-item">
        ...
        <div className="timeline-content">
          ...
          <div className="flex gap-2 mt-4">
            <H4>{formatDate.format(item.startDate)} to {formatDate.format(item.endDate)}</H4>
            ...
            <div className="md:grid md:grid-cols-5 gap-4 flex flex-col">
              ...
              <div className="col-span-2 flex flex-col">
                ...
                <div className="gap-4">
                  ...
                  <P>I love to learn and the fast paced creative nature of software development has become a passion of mine.</P>
                </div>
              </div>
            </div>
          </div>
    ...
    <div>
        ...
        <SidebarMain>
          ...
          <div className="flex gap-20">
            <div className="flex flex-col gap-4 mt-8">
              <H3 className="mx-auto mb-4">Team Lead</H3>
            ...
            <Tile image={headshotImg} classes="my-auto" />
          </div>
          <div className="flex gap-20">
            <Tile image={eagleScoutImg} classes="my-auto"/>
            <div className="flex flex-col gap-4 mt-8">
              <H3 className="mx-auto mb-4">Eagle Scout</H3>
      ...
      <SectionWithSidebar orientation="right">
        <SidebarMain>
          <div className="flex gap-20">
            <div className="flex flex-col gap-4 mt-8">
              <H2 className="mx-auto mb-4">UAS Pilot Part 107 Licensed</H2>
    ...
    <div>
      ...
      <SectionWithSidebar orientation="left" >
        ...
        <SidebarMain>
          ...
          <div className="flex gap-20">
            <Tile image={fiveInchDroneImg} />
            <div className="flex flex-col gap-4 mt-8">
              <H3>FPV Drone Freestyle</H3>
          ...
          <div className="flex gap-20">
            ...
            <Tile image={printerImg} />
          </div>
          <div className="flex gap-20">
            <Tile image={campfireMeImg} />
            <div className="flex flex-col gap-4 mt-8">
              <H3>Outdoors</H3>
