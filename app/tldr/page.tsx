...
export default async function TLDR(props: { res: ApiResponse }) {
  ...
  return <Column classes="gap-1">
    ...
    <p>I don't believe in problems, only challenges that haven't been solved.</p>
    <h3>Skills</h3>
    <ol>
      <li>Eagle Scout</li>
      <li>Team Oriented</li>
      <li>Consistent and dependable team member</li>
      <li>Team work makes the dream work</li>
      <li>Willing to take responsibility, set an example, and lead</li>
      <li>Revels in a good challenge</li>
      <li>Thinks in terms of solutions rather than problems</li>
    </ol>
